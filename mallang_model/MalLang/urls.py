...
urlpatterns = [
    ...
    path('searchengine/', views.search_engine, name="searchengine"),
    path('search_view/', views.SearchView.as_view(), name="search"),
    path('tts_diary/', views.tts_diary, name="tts_diary"),
]
