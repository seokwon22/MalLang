...
if not os.listdir(f'{save_path}dataset'):
    ...
    train_idx, train_src = tokenize_ko_dataset("dataset/dataset/korean_english_train_ko.txt") # max token length = 129
    valid_idx, valid_src = tokenize_ko_dataset("dataset/dataset/korean_english_valid_ko.txt") # max token length = 90
    test_idx, test_src = tokenize_ko_dataset("dataset/dataset/korean_english_test_ko.txt") # max token length = 107
    train_src, train_tgt = tokenize_en_dataset("dataset/dataset/korean_english_train_en.txt", train_idx, train_src) # max token length = 96
    valid_src, valid_tgt = tokenize_en_dataset("dataset/dataset/korean_english_valid_en.txt", valid_idx, valid_src) # max token length = 71
    test_src, test_tgt = tokenize_en_dataset("dataset/dataset/korean_english_test_en.txt", test_idx, test_src) # max token length = 74
